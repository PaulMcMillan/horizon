...
from horizon.auth.forms import Login, LoginWithTenant
from horizon.auth.keystone import User
...
def switch_tenants(request, tenant_id):
    ...
    if unscoped_token:
        try:
            ...
            user = User(users.get_user_from_request(request))
...
def logout(request):
    ...
    return django_logout(request, settings.LOGIN_URL)
